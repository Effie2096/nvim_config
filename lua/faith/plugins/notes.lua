...
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function()
		...
		vim.cmd.packadd("markdown-table-mode.nvim")
		vim.cmd.packadd("bullets.vim")
		vim.cmd.packadd("render-markdown.nvim")
		vim.cmd.packadd("checkmate.nvim")
		-- vim.fn.exists('g:loaded_bullets_vim')
		...
		require("markdown-table-mode").setup(mtm_opts)
		...
		require("render-markdown").setup(rmd_opts)
		...
		require("checkmate").setup(cm_opts)
...
local obsidian_maps = {
	...
	},
	{
		...
		mode = "n",
		desc = "[o]bsidian [f]ind [w]orkspace: Open picker listing workspaces.",
	},
	{
		lhs = "<localleader>ol",
		rhs = function()
...
wk.add(vim.list_extend(
		...
		:totable(),
	{
		...
		{ "<leader>od", group = "Obsidian dalies" },
		{ "<leader>ot", group = "Obsidian templates" },
...
local function get_workspaces()
	...
	local vaults = {
		{
			path = vim.fn.glob(("%s/BrainFart"):format(vaults_dir), true, false),
			name = "BrainFart",
			overrides = {
				templates = {
