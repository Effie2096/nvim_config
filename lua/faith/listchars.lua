...
local listchars = [[eol:]]
	.. icons.characters.eol
	.. [[,extends:]]
	.. icons.characters.extends
	.. [[,nbsp:]]
	.. icons.characters.nbsp
	.. [[,precedes:]]
	.. icons.characters.precedes
	.. [[,space:]]
	.. icons.characters.space
	.. [[,tab:]]
	.. icons.characters.tab
	.. [[,trail:]]
	.. icons.characters.trail
...
nnoremap("<leader>lc", "<cmd>ToggleListChars<CR>", desc(opts, "[l]ist [c]hars: Toggle showing listchar indicators."))
